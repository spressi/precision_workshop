...
-   `a`, `multi` etc. are the variable names <span style="font-size: 16px;">(some naming rules, e.g., no whitespace, must no start with an number, many special characters not allowed)</span>
